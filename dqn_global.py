...
from deeprl_prj.dqn_tf_spatialAt_global_dqn import DQNAgent
#from deeprl_prj.dqn_tf_spatialAt_common_drqn import DQNAgent
#from deeprl_prj.dqn_tf_spatialAt_local_dqn4 import DQNAgent
#from deeprl_prj.dqn_tf_temporalAtrnn4 import DQNAgent
#from deeprl_prj.dqn_tf_spatialAt_bidirlstm import DQNAgent
...
def main():
    ...
    parser.add_argument('--env', default='MsPacman-v4', help='Atari env name')
    ...
    parser.add_argument('--replay_memory_size', default=200000, type=int, help='Number of replay memory the agent uses for training')
